...
import EducationCard from "@/modules/settings/ui/components/EducationCard";
...
const EducationListView = ({ username, onEdit }: EducationListViewProps) => {
  ...
  const handleDelete = async () => {
    ...
    try {
      await deleteEducation({
        educationId: deleteId as EducationId,
      });
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 w-full lg:max-w-7xl mx-auto relative">
      ...
      <ConfirmDialog
        ...
        description="Are you sure you want to delete this education entry? This action
              cannot be undone."
        confirmText="Delete"
        cancelText="Cancel"
        variant="destructive"
